...
<html>
<head>
    <title>Liste des opérations de dépôt</title>
    <style>
        body { 
...
<body>
    <div class="container">
        <div class="header">
            <h1>Liste des opérations de dépôt</h1>
        </div>
        ...
        <div class="navigation">
            <form action="${pageContext.request.contextPath}/depot" method="get" style="display: inline;">
                <button class="button button-primary" type="submit">Retour aux dépôts</button>
            </form>
    ...
    <script>
        ...
        try {
            ...
            let tbody = document.querySelector("#depotTable tbody");
            ...
            document.getElementById("error").textContent = "Erreur lors de l'affichage des dépôts : " + e.message;
        }
    </script>
</body>
</html>